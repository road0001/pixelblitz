...
ARGUMENTS:
	...
	3) $vars : Object - An object containing the end values of all the properties you'd like to have tweened (or if you're using the 
		  ...
		  SPECIAL PROPERTIES:
			  ...
			  shortRotation : Number - To tween the rotation property of the target object so that it automatically travels
			  						 the shortest distance, use "shortRotation" instead of "rotation" as the property. For example,
			  						 if myObject.rotation is currently 170 degrees and you want to tween it to -170 degrees, a normal 
			  						 rotation tween would travel a total of 340 degrees in the counter-clockwise direction,
